...
import { addNews } from "./news.query";
import dayjs from "dayjs";
const { TabPane } = Tabs;

const SideMenuNews = ({ open, setOpen }) => {
  ...
  const mutation = useMutation(addNews, {
    ...
    onError: () => {
      setLoader(false);
      message?.error("yangilikni yaratishda xatolik ketti!");
    },
  });
      ...
      >
        <Formik
          ...
          onSubmit={(values, { setSubmitting }) => {
            setLoader(true);
            mutation.mutate({ ...values, news_data: Date.now() });
            setSubmitting(false);
          }}
        >
